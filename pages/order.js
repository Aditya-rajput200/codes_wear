        ...
        <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            ...
            <div class="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                <div
                    ...
                    <div class="data">
                        <p class="font-semibold text-base leading-7 text-black">Order Id: <span class="text-pink-500 font-medium">#10234987</span></p>
                        <p class="font-semibold text-base leading-7 text-black mt-4">Order Payment : <span class="text-gray-400 font-medium"> 18th march
                            2021</span></p>
                    </div>
                    <button
                        class="rounded-full py-3 px-7 font-semibold text-sm leading-7 text-white bg-pink-500 max-lg:mt-5 shadow-sm shadow-transparent transition-all duration-500 hover:bg-pink-700 hover:shadow-pink-400">Track
                        Your Order</button>
                </div>
                                ...
                                <div class="grid grid-cols-5">
                                    <div class="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                                        <div class="flex gap-3 lg:block">
                                            ...
                                            <p class="lg:mt-4 font-medium text-sm leading-7 text-pink-500">₹100</p>
                                        </div>
                                    </div>
                                ...
                                <div class="grid grid-cols-5">
                                    ...
                                    <div class="col-span-5 lg:col-span-2 flex items-center max-lg:mt-3 ">
                                        <div class="flex gap-3 lg:block">
                                            ...
                                            <p
                                                class="font-medium text-sm leading-6 py-0.5 px-3 whitespace-nowrap rounded-full lg:mt-3 bg-pink-50 text-pink-500">
                                                Dispatched</p>
                                        </div>
                ...
                <div class="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                    <div class="flex flex-col sm:flex-row items-center max-lg:border-b border-gray-200">
                        <button
                            class="flex outline-0 py-6 sm:pr-6  sm:border-r border-gray-200 whitespace-nowrap gap-2 items-center justify-center font-semibold group text-lg text-black bg-white transition-all duration-500 hover:text-pink-500">
                            <svg class="stroke-black transition-all duration-500 group-hover:stroke-pink-500" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                    ...
                    <p class="font-semibold text-lg text-black py-6">Total Price: <span class="text-pink-500">₹ {subTotal}</span></p>
                </div>
