        ...
        <>
            ...
            <div className="h-screen grid grid-cols-3 mt-20">
                <div className="lg:col-span-2 col-span-3 bg-indigo-50 space-y-8 px-12">
                                    ...
                                    <label className="flex border-t border-gray-200 h-12 py-3 items-center select relative">
                                        ...
                                        <div id="country" className="focus:outline-none px-3 w-full flex items-center">
                                            <select name="country" className="border-none bg-transparent flex-1 cursor-pointer appearance-none focus:outline-none">
                                                ...
                                                <option value="Af">Afganisthant</option>
                    ...
                    <button className="submit-button px-4 py-3 rounded-full bg-pink-500 hover:bg-pink-600 text-white focus:ring focus:outline-none w-full text-xl font-semibold transition-colors">
                        Pay ₹{subTotal}
                    </button>
                </div>
